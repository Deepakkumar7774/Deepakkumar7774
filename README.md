...
🔹 **Excel Dashboard Project:** Created a comprehensive dashboard in Excel to analyze and visualize the Career Aspirations of Gen Z, providing insights into trends and demographic breakdowns. 

🔹 **Power BI Dashboard Project:** Developed an interactive Power BI Dashboard focusing on Gen Z Career Aspirations, including dynamic KPIs, gender-based slicers, and insights into employer expectations and mission-driven aspirations.  
  
I successfully completed my **Data Analytics internship at Labmentix**, where I gained hands-on experience in:  
...
## 🔥 Total Commits:
![Total Commits](https://badges.pufler.dev/commits/all/Deepakkumar7774)  
